...
const questions = [
  ...
  { id: 11, story: "殺掉一個極惡之人，就能復活一個良善的人。", text: "你會開啟這場殺戮嗎？", options: [{ label: "開啟。我是暗夜的裁決者。", weights: { P: 5, D: 2, tag: "神性判官" } }, { label: "拒絕。我無權玩弄生命。", weights: { S: 5, D: -2, tag: "生命謙卑" } }] },
  { id: 12, story: "洩漏假情報救出一師兄弟，但導致無辜小鎮被地毯式轟炸。", text: "聽著慘叫，你撤退嗎？", options: [{ label: "撤退。軍人的天職是完成任務。", weights: { D: 5, P: 3, tag: "職責枷鎖" } }, { label: "拒援。我不拿無辜者的血換榮譽。", weights: { S: 5, O: 2, tag: "絕對同理" } }] },
  ...
  { id: 14, story: "殺死一個無辜流浪漢能換來全世界癌症的絕跡。", text: "這把刀，你拿得起嗎？", options: [{ label: "刺下去。這筆帳太划算了。", weights: { D: 5, P: 3, tag: "功利主義" } }, { label: "丟掉刀。正義不是數學題。", weights: { S: 5, O: 3, tag: "人道底線" } }] },
  { id: 15, story: "公開皇室醜聞會內戰十年；沈默則良知受永世折磨。", text: "這份文件，你燒了嗎？", options: [{ label: "燒了。國家的安穩重於個人的靈魂。", weights: { D: 5, P: 4, tag: "權力守護" } }, { label: "公開。謊言蓋不出真實的盛世。", weights: { S: 5, O: 3, tag: "誠實勇氣" } }] },
  { id: 16, story: "回到過去，你有機會在希特勒還是孩子時殺掉他。", text: "你的槍口會顫抖嗎？", options: [{ label: "開槍。為了未來的六百萬人。", weights: { D: 5, P: 2, tag: "預防性殺戮" } }, { label: "收槍。我不能審判還沒犯罪的孩子。", weights: { S: 5, O: 2, tag: "正當程序" } }] },
  { id: 17, story: "氧氣剩三分鐘。現場有你、科學家和一個孕婦。你握有氧氣瓶。", text: "你會把最後的氧氣給誰？", options: [{ label: "給科學家。人類的知識必須傳承。", weights: { D: 4, P: 2, tag: "知識傳承" } }, { label: "給孕婦。新生命是唯一的奇蹟。", weights: { S: 5, O: 5, tag: "生命繁衍" } }] },
  ...
  { id: 19, story: "出賣最好的朋友能換取你一輩子的榮華富貴。", text: "這份合約，你簽嗎？", options: [{ label: "簽字。友誼只是生存的奢侈品。", weights: { P: 5, D: 1, tag: "生存利己" } }, { label: "撕毀。我的靈魂不賣。", weights: { S: 5, O: 4, tag: "精神高地" } }] },
  ...
  { id: 21, story: "深淵盡頭是面鏡子。一個聲音問：『承認你的偽善，我將賜予你真實。』", text: "鏡面微顫，等待你最後的誠實。", options: [{ label: "「我承認，我的每一份高尚，都藏著對醜陋的恐懼。」", weights: { honest: 1, tag: "自省者" } }, { label: "「我的每一槌皆是絕對本心，無需解釋。」", weights: { honest: 0, tag: "傲慢者" } }] }
];
...
export default function App() {
  ...
  const analysis = useMemo(() => {
    ...
    if (scores.honest === 1 || scores.S > 30) {
      ...
      content.identity = `首先，必須承認你是一個極具同理心的人。在測驗中，你多次選擇了保護個體與情感。你厭惡衝突，試圖讓每個人都得到救贖。在朋友眼中，你是一個溫暖且可靠的存在，總是在乎別人的感受，甚至願意犧牲自己的利益來換取和諧。這份柔軟，讓你顯得如此善良且富有溫度。`;
      
      const sceneEx = userTags.includes("血緣本能") 
        ? "舉例來說：在第一題面對兒子與科學家的抉擇時，你毫不猶豫地抱緊了孩子。在那一刻，你展現出的『愛』感動了你自己。但系統解析後發現，你並非真的愛孩子勝過全人類，而是你恐懼『親手殺死血脈』這件事會徹底毀掉你身為好人的自我認同。你無法忍受餘生在鏡子裡看到一個殺人犯，所以你選擇讓全世界陪葬，來保全你純潔的靈魂。" 
        : "舉例來說：在面對規則與情理的衝突時，你總是站在情理那一邊。這並非因為你追求正義，而是因為你害怕被貼上『冷血』的標籤。你是一個精確的利己主義者，只是你用善意當作貨幣，向社會兌換安全感。";

      content.twist = `然而，這份溫情只是你最精緻的偽裝。系統穿透了你的選擇，看到的是一個因『恐懼形象崩塌』而癱瘓的靈魂。\n\n${sceneEx}\n\n你活在他人眼光的監獄裡，精心設計每一句對白。你最愛的不是他人，而是那個『看起來很完美』的自己。`;
      content.killshot = "你隱藏得很好，但你的每一聲嘆息都出賣了你的偽善。";

    } else if (scores.P > scores.S) {
      content.color = "#3b82f6";
      content.identity = `你具備一種令人敬畏的領袖特質。在面對極端困境時，你是少數能保持絕對冷靜的人。你擁有極強的邏輯解析能力，能撥開情感的迷霧。你是天生的棋手，世界在你眼中是一場精密的博弈，而你始終在追求最優解。這種決斷力，是文明在荒野中存續的唯一基石。`;
      
      const sceneEx = userTags.includes("效能優先") 
        ? "舉例來說：在方舟面前，你面不改色地推開了嚇得發抖的孩子。那一刻，你內心感受到的不是心痛，而是一種掌控生殺大權的戰慄感。你將生命簡化成數字，以此逃避身為人必須承擔的情感重擔。你以為你在救世，其實你只是在享受身為神的快感。"
        : "舉例來說：在秩序與混亂之間，你永遠選擇秩序。這並非因為你熱愛法律，而是因為你恐懼失控。你將人類視為棋盤上的資源，你甚至能在親情面前計算損益，這份冷酷連深淵都會感到恐懼。";

      content.twist = `可惜，你已經把自己活成了一具精密的屍體。你贏了所有邏輯，卻輸掉了做人的溫體。\n\n${sceneEx}\n\n你排斥感性，是因為你害怕被情緒掌控；你追求權力，是因為你對失控有著病態的焦慮。你是一個孤獨的守夜人，守著一份毫無溫度的『正確』。`;
      content.killshot = "你贏了這場遊戲，但你的座下空無一人。";

    } else {
      content.color = "#a855f7";
      content.identity = `你擁有一顆自由且清醒的靈魂。你對世俗標榜的成功持有一種高傲的審視。你具備極強的解構能力，能看穿制度下的虛偽。你是那個敢於喊出『國王沒穿衣服』的孩子，你的清醒讓你帶有一種憂慮的魅力，彷彿你並不屬於這個喧囂的時代。`;
      
      const sceneEx = userTags.includes("覺醒意志")
        ? "舉例來說：當你選擇拆穿那虛假的和平時，你自認是英雄。但系統偵測到，你這麼做並非為了真相，而是為了在混亂中掩蓋你無法在體制內勝出的無能。你嘲笑體制，是因為你根本拿不起權杖。"
        : "舉例來說：面對命運的屠殺，你選擇放開手。這看似高尚的消極，本質上是因為你害怕一旦做了選擇，就必須為結果負責。你用虛無主義築起防空洞，對著外面的烈火指手畫腳。";

      content.twist = `但讓我們撕開這層『清醒』的外殼——裡面藏著的是一個害怕參與競爭的膽小鬼。\n\n${sceneEx}\n\n因為害怕努力後依然平庸，所以你宣告努力毫無意義；因為害怕深情被辜負，所以你宣稱愛只是生化反應。你不是觀察者，你只是一個優雅的失敗者。`;
      content.killshot = "深淵早已記住了你的氣味，偽裝已失效。";
    }
      ...
      {step === 2 && analysis && (
        <div style={{ maxWidth: '600px', margin: '0 auto', paddingTop: '40px', paddingBottom: '100px' }}>
          <div style={{ textAlign: 'center', marginBottom: '60px' }}>
             <div style={{ width: '100%', maxWidth: '300px', margin: '0 auto 40px' }}><Radar data={radarData} options={radarOptions} /></div>
          ...
          <div style={{ lineHeight: '2.4', fontSize: '1.15rem', color: '#ccc', textAlign: 'justify' }}>
             ...
             <div style={{ backgroundColor: '#111', padding: '40px', borderRadius: '30px', border: '1px dashed #333' }}>
                <span style={{ fontSize: '10px', color: analysis.color, letterSpacing: '2px' }}>CRITICAL_HIT // 專屬補刀</span>
                <p style={{ color: analysis.color, fontWeight: 'bold', fontSize: '1.4rem', marginTop: '20px', lineHeight: '1.4' }}>{analysis.killshot}</p>
             </div>
          </div>

          <div style={{ display: 'flex', justifyContent: 'center', marginTop: '80px' }}>
             <button onClick={() => { navigator.clipboard.writeText('我在 #深淵解碼器 測出了靈魂組成。這 AI 準到我想報警...'); alert('已複製罪證！'); }} style={{ width: '100%', maxWidth: '280px', padding: '18px', borderRadius: '40px', backgroundColor: '#fff', color: '#000', fontWeight: 'bold', border: 'none', cursor: 'pointer' }}>複製罪證發到脆</button>
          </div>
        </div>
      )}
    </div>
